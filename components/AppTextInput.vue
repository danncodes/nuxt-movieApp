...
<main class="w-full my-4 relative flex items-center h-8 max-w-md mx-auto">
    ...
    <input @input="userInput" type="text" :placeholder="placeholder" class="w-full p-2 pl-4 rounded rounded-l-none bg-gray-50 text-black text-xs outline-none duration-300 focus:shadow-md focus:border-t-4 focus:textbase border-[#0FEFFD]" ref="input">
