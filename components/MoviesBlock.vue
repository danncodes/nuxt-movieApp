...
export default {
    ...
    methods:{
        scrollFinished(){
            // let scrollBlock = this.$refs.block

            // console.log(scrollBlock.clientWidth, "Client Width")
            // console.log(scrollBlock.scrollWidth, "Scroll Width")
            // console.log(window.pageXOffset, "Offset")
